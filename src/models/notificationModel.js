...
const REMIND_DUEDATE_IN_CARD_NOTIFICATION_SCHEMA = Joi.object({
  boardId: Joi.string().required().pattern(OBJECT_ID_RULE).message(OBJECT_ID_RULE_MESSAGE),
  boardTitle: Joi.string().required(),
  cardId: Joi.string().required().pattern(OBJECT_ID_RULE).message(OBJECT_ID_RULE_MESSAGE),
  cardTitle: Joi.string().required()
...
const OVERDUE_DUEDATE_IN_CARD_NOTIFICATION_SCHEMA = Joi.object({
  boardId: Joi.string().required().pattern(OBJECT_ID_RULE).message(OBJECT_ID_RULE_MESSAGE),
  boardTitle: Joi.string().required(),
  cardId: Joi.string().required().pattern(OBJECT_ID_RULE).message(OBJECT_ID_RULE_MESSAGE),
  cardTitle: Joi.string().required()
...
const NOTIFICATION_SCHEMAS = {
  ...
  remindDueDateInCard: REMIND_DUEDATE_IN_CARD_NOTIFICATION_SCHEMA,
  overdueDueDateInCard: OVERDUE_DUEDATE_IN_CARD_NOTIFICATION_SCHEMA
}
